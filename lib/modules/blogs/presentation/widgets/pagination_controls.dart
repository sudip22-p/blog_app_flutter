      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: onPressed != null
              ...
              : context.customTheme.surface.withValues(alpha: 0.3),
          borderRadius: BorderRadius.circular(12),
          border: Border.all(
            color: context.customTheme.outline.withValues(alpha: 0.3),
            width: 1,
          ),
          ...
          child: InkWell(
            ...
            child: Icon(
              ...
              color: onPressed != null
                  ...
                  : context.customTheme.contentSurface.withValues(alpha: 0.5),
              size: 24,
            ),
          ),
        ),
...
class _PageIndicator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: context.customTheme.surface.withValues(alpha: 0.8),
